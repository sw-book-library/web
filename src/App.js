        ...
        return (
          <li key={key}>
            <ul className="linha-dados">
              ...
              <li style={{ width: '140px', textAlign: 'center' }}>{Moment(val.productionYear).locale('en-gb').format('DD/MM/YYYY')}</li>
        ...
        return (
          <li key={key}>
            <ul className="linha-dados">
              ...
              <li style={{ width: '150px', textAlign: 'center' }}>{Moment(val.createdAt).locale('en-gb').format('DD/MM/YYYY')}</li>
        ...
        return (
          <li key={key}>
            <ul className="linha-dados">
              ...
              <li style={{ width: '140px', textAlign: 'center' }}>{Moment(val.createdAt).locale('en-gb').format('DD/MM/YYYY')}</li>
              <li style={{ width: '140px', textAlign: 'center' }}>{Moment(val.returnDate).locale('en-gb').format('DD/MM/YYYY')}</li>
